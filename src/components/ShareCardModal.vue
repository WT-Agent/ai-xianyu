    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">咸鱼高价转让文案</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 咸鱼闲置高价文案助手</span>
...
// 清理回复末尾的特殊标记 [XIANYU_SCORES]...[/XIANYU_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[XIANYU_SCORES\][\s\S]*?\[\/XIANYU_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 咸鱼闲置高价爆款文案神器】\n\n${cleanContent.value}\n\n体验咸鱼高价文案AI助手：https://ai.wuxian.xyz`;
